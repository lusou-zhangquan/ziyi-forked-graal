...
public class AnalysisFeatureManager {
    ...
    public static class Options {
        @Option(help = "Comma separated features used in standalone analysis.")//
    ...
    public void registerFeaturesFromOptions() {
        String features = Options.AnalysisTimeFeatures.getValue(options);
        if (features != null) {
            for (String featureName : features.split(",")) {
