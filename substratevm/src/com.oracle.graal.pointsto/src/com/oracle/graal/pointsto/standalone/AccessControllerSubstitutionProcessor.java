...
import com.oracle.graal.pointsto.standalone.replacements.AccessControllerSubstitution;
...
public class AccessControllerSubstitutionProcessor extends SubstitutionProcessor {
    ...
    private AnalysisClassLoader aClassLoader;
    private final Class<?> accessControllerSubstitutionClass;
    private Map<ResolvedJavaMethod, ResolvedJavaMethod> substitutions;

    public AccessControllerSubstitutionProcessor(MetaAccessProvider metaAccess, AnalysisClassLoader aClassLoader) {
