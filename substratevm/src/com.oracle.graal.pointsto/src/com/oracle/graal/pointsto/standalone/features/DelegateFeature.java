...
public abstract class DelegateFeature implements Feature {
    ...
    public DelegateFeature(OptionValues options) {
        DelegateSVMFeature annotation = DirectAnnotationAccess.getAnnotation(this.getClass(), DelegateSVMFeature.class);
        if (annotation == null) {
        ...
        try {
            ...
            Feature originalFeature = ReflectionUtil.lookupConstructor(originalFeatureClass).newInstance();
