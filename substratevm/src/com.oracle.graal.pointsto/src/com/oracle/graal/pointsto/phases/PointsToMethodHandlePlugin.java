...
public class PointsToMethodHandlePlugin implements NodePlugin {
    ...
    public PointsToMethodHandlePlugin(HostedProviders providers, AnalysisUniverse aUniverse, Providers parsingProviders, ClassInitializationPlugin classInitializationPlugin,
