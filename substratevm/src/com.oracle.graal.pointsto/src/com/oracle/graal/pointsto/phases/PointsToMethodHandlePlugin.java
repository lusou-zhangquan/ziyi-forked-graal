 ...
 * Copyright (c) 2021, 2022, Alibaba Group Holding Limited. All rights reserved.
...
public class PointsToMethodHandlePlugin implements NodePlugin {
    ...
    private boolean isVarHandleMethod(ResolvedJavaMethod method, ValueNode[] args) {
        ...
        if (isVarHandleGuards(method)) {
            ...
            try {
                 ...
                 */
                VarHandle varHandle = (VarHandle) asObject(args[0].asJavaConstant());
    ...
    private static void registerInvocationPlugins(InvocationPlugins plugins, Replacements replacements) {
        ...
        r.register(new InvocationPlugin.RequiredInvocationPlugin("ensureInitialized", InvocationPlugin.Receiver.class) {
            @Override
        ...
        r.register(new InvocationPlugin.OptionalInvocationPlugin("maybeCustomize", MethodHandle.class) {
            @Override
        ...
        r.register(new InvocationPlugin.RequiredInvocationPlugin("requireNonNull", Object.class) {
            @Override
