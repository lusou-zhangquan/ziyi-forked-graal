...
public class PointstoReflectionRegistryAdapter extends AbstractReflectionRegistryAdapter {
    private final ClassLoader classLoader;

    public PointstoReflectionRegistryAdapter(ReflectionRegistry reflectionRegistry, ClassLoader loader) {
    ...
    private TypeResult<Class<?>> forName(String name) throws ClassNotFoundException {
        if (name.indexOf('.') == -1) {
