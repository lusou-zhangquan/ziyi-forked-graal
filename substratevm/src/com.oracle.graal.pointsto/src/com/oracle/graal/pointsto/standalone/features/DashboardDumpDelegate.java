...
public class DashboardDumpDelegate {
    ...
    public static class Options {
        @Option(help = "Dump pointsto analysis results to a json file, as a combination of -H:DashboardDump= and -H:+DashboardPointsTo and -H:+DashboardJson.")
//
        public static final OptionKey<String> DumpAnalysisReports = new OptionKey<String>(null) {
    ...
    public static class Feature extends DelegateFeature {
        ...
        protected boolean isEnabled(OptionValues options) {
            return Options.DumpAnalysisReports.getValue(options) != null;
        }

        @SuppressWarnings("unchecked")
        @Override
        public void beforeAnalysis(BeforeAnalysisAccess access) {
            AnalysisFeatureImpl.BeforeAnalysisAccessImpl a = (AnalysisFeatureImpl.BeforeAnalysisAccessImpl) access;
