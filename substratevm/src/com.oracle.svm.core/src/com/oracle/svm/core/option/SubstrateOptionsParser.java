...
public class SubstrateOptionsParser {
    ...
    public static void collectOptions(List<Class<? extends OptionDescriptors>> optionsClasses, Consumer<OptionDescriptor> optionDescriptorConsumer) {
        try {
            CommonOptionParser.collectOptions(optionsClasses, optionDescriptorConsumer);
        } catch (Exception e) {
