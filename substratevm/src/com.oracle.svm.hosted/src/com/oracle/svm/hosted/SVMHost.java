...
public class SVMHost extends HostVM {
    ...
    @Override
    protected void checkClassInitializerSideEffect(BigBang bb, AnalysisMethod method, Node n) {
        super.checkClassInitializerSideEffect(bb, method, n);
        if (n instanceof VMThreadLocalAccess) {
            /*
