 ...
 * compiled with VM specific 9+, so that the String concact operation will be compiled into
 * invokeDynamic.
 */
public class PointstoInvokeDynamicTest {
    ...
    public void test() {
        ...
        tester.setAnalysisArguments("-H:AnalysisEntryClass=com.oracle.graal.pointsto.test.PointstoInvokeDynamicTest",
