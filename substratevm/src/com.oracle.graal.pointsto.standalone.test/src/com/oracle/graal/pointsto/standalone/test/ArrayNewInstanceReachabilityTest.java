 ...
 * {@link org.graalvm.compiler.replacements.StandardGraphBuilderPlugins#registerInvocationPlugins}
 * has been invoked.
 */
public class ArrayNewInstanceReachabilityTest {
    ...
    @Test
    public void testClassEquality() throws NoSuchMethodException {
        ...
        tester.setExpectedReachableMethods(C.class.getDeclaredMethod("foo"));
