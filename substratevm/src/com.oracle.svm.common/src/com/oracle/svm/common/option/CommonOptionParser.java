...
public class CommonOptionParser {
    ...
    public static void collectOptions(List<Class<? extends OptionDescriptors>> optionsClasses, Consumer<OptionDescriptor> optionDescriptorConsumer) throws ReflectiveOperationException {
        for (Class<? extends OptionDescriptors> optionsClass : optionsClasses) {
            ...
            OptionDescriptors descriptors = optionsClass.getDeclaredConstructor().newInstance();
