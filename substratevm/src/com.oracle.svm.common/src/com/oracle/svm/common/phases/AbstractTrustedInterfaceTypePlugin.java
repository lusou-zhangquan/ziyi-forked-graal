...
abstract public class AbstractTrustedInterfaceTypePlugin implements TypePlugin {
    @Override
    public StampPair interceptType(GraphBuilderTool b, JavaType declaredType, boolean nonNull) {
        ...
        if (castedType != null) {
            /*
             * We have the static analysis to check interface types, e.g.., if a parameter of
             * field has a declared interface type and is assigned something that does not
             * implement the interface, the static analysis reports an error.
             */
    ...
    abstract protected JavaType castType(JavaType declaredType);
}
